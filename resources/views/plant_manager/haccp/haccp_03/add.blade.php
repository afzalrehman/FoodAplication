...
@section('content')
    <div class="main-content">
        ...
        <div class="product-count d-flex align-items-center gap-3 gap-lg-4 mb-3 fw-medium flex-wrap font-text1">
            ...
            <a href="{{ route('plantmanager.haccp_3.index') }}"><span>HACCP 03</span><span class="text-secondary"></span></a>
            <a href="#"><span>Add</span><span class="text-secondary"></span></a>
        </div>

        <form method="POST" action="{{ route('plantmanager.haccp_3.store') }}" class="needs-validation" novalidate
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="thermo_id" placeholder="Enter Thermo ID" required>
                        </div>
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="personal_thermometer"
                                placeholder="Enter Personal Thermometer Readings" required>
                        </div>
                        <div class="col-xl-6 mb-3">
                        ...
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="corrective_action"
                                placeholder="Enter Corrective action" required>
                        </div>
                        <div class="col-xl-6 mb-3">
                            <label class="form-label">8. Preventive action
                                <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control" name="preventive_action" placeholder="Enter Preventive action" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4 ">
                <div class="col-md-12 mb-3">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        ...
                        <a href="{{ route('plantmanager.haccp_3.index') }}" class="btn btn-danger px-4">Back</a>
                    </div>
                </div>
            </div>
