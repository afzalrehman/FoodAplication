...
@section('content')
    <div class="main-content">
        ...
        <div class="product-count d-flex align-items-center gap-3 gap-lg-4 mb-3 fw-medium flex-wrap font-text1">
            ...
            <a href="{{ route('plantmanager.haccp_2.index') }}"><span>HACCP 02</span><span class="text-secondary"></span></a>
            <a href="#"><span>Add</span><span class="text-secondary"></span></a>
        </div>

        <form method="POST" action="{{ route('plantmanager.haccp_2.store') }}" class="needs-validation" novalidate
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="internal_temp"
                                placeholder="Enter Internal Temperature" required>
                        </div>
                        <div class="col-xl-6 mb-3">
                            <label class="form-label">5. Initials
                                <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control" name="initials" placeholder="Enter Your Initials" required>
                        </div>
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="pre_shipper"
                                placeholder="Enter Pre-shipper Signature" required>
                        </div>
                        <div class="col-xl-6 mb-3">
                            <label class="form-label">7. Date
                                <span class="text-danger">*</span>
                            </label>
                            <input type="date" class="form-control datepicker" name="verification_date" placeholder="Select Date" required>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="verified_initials"
                                placeholder="Enter Verified Initials" required>
                        </div>
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="date" class="form-control datepicker" name="verified_date"
                                placeholder="Select Verified Date" required>
                        </div>
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="time" class="form-control time_picker" name="verified_time"
                                placeholder="Select Verified Time" required>
                        </div>
                        <div class="col-xl-6 mb-3">
            ...
            <div class="row mb-4 ">
                <div class="col-md-12 mb-3">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        ...
                        <a href="{{ route('plantmanager.haccp_2.index') }}" class="btn btn-danger px-4">Back</a>
                    </div>
                </div>
            </div>
