...
@section('content')
    <div class="main-content">
        <div class="product-count d-flex align-items-center gap-3 gap-lg-4 mb-4 fw-medium flex-wrap font-text1">
            ...
            <a href="{{ route('plantmanager.sqf_2.index') }}"><span>SQF 02</span><span class="text-secondary"></span></a>
            <a href="#"><span>Edit</span><span class="text-secondary"></span></a>
        </div>
        <form method="POST" action="{{ route('plantmanager.sqf_2.edit', $sqf02Record->id) }}" class="row g-3 needs-validation"
                    ...
                    <div class="card rounded-4 border-top border-4 border-primary border-gradient-1">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-start justify-content-between mb-3">
                                <div class="">
                                    <h5 class="mb-0 fw-bold">Edit SQF02</h5>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    ...
                                    <a href="{{ route('plantmanager.sqf_2.index') }}" class="btn btn-danger px-4">Back</a>
                                </div>
                            </div>
