...
@section('content')
    <div class="main-content">
        <div class="product-count d-flex align-items-center gap-3 gap-lg-4 mb-4 fw-medium flex-wrap font-text1">
            ...
            <a href="{{ route('plantmanager.sqf_1.index') }}"><span>SQF 01</span><span class="text-secondary"></span></a>
            <a href="#"><span>Edit</span><span class="text-secondary"></span></a>
        </div>
        <form method="POST" action="{{ route('plantmanager.sqf_1.edit', $sqf01Record->id) }}" class="row g-3 needs-validation"
                    ...
                    <div class="card rounded-4 border-top border-4 border-primary border-gradient-1">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-start justify-content-between mb-3">
                                <div class="">
                                    <h5 class="mb-0 fw-bold">Edit SQF01</h5>
                                </div>
                            ...
                            <div class="g-3 mt-0 row justify-content-between">
                                ...
                                <div class="col-xl-6">
                                    <div class=" custom-checkbox">
                                        <label for="handwash_station" class="form-label">3. Handwash station - paper,
                                            soap,
                                            hot
                                            water
                                            <span class="text-danger">*</span>
                                ...
                                <div class="col-xl-6">
                                    <div class=" custom-checkbox">
                                        <label for="all_contact_surfaces" class="form-label">22. All contact surfaces
                                            are
                                            intact
                                            <span class="text-danger">*</span>
                                        </label>
                                ...
                                <div class="col-xl-6">
                                    <div class=" custom-checkbox">
                                        <label for="no_rodent_droppings" class="form-label">27. No rodent droppings,
                                            no
                                            rodent or pest
                                            activities
                                            <span class="text-danger">*</span>
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    ...
                                    <a href="{{ route('plantmanager.sqf_1.index') }}" class="btn btn-danger px-4">Back</a>
                                </div>
                            </div>
