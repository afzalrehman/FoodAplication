...
@section('content')
    <div class="main-content">
        <div class="product-count d-flex align-items-center gap-3 gap-lg-4 mb-4 fw-medium flex-wrap font-text1">
            ...
            <a href="{{ route('qc.haccp_1.index') }}"><span>HACCP 01</span><span class="text-secondary"></span></a>
            <a href="#"><span>Edit</span><span class="text-secondary"></span></a>
        </div>


        <form method="POST" action="{{ route('qc.haccp_1.update', $haccp01Record->id) }}" class="needs-validation" novalidate
