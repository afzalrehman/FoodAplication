                        ...
                        <div class="row">
                            <div class="col-12 col-sm-7">
                                <div class="d-flex align-items-center gap-3 mb-5">
                                    <img src="{{asset('assets/images/avatars/01.png')}}" class="rounded-circle bg-grd-info p-1"
                ...
                <div class="card w-100 rounded-4">
                    ...
                    <div class="card-body p-0">
                        <div class="user-list p-3">
                            <div class="d-flex flex-column gap-3">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('assets/images/avatars/01.png')}}" width="45" height="45"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('assets/images/avatars/02.png')}}" width="45" height="45"
                                        class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('assets/images/avatars/03.png')}}" width="45" height="45"
                                        class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('assets/images/avatars/04.png')}}" width="45" height="45"
                                        class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('assets/images/avatars/05.png')}}" width="45" height="45"
                                        class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('assets/images/avatars/06.png')}}" width="45" height="45"
                                        class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img src="{{asset('assets/images/avatars/08.png')}}" width="45" height="45"
                                        class="rounded-circle" alt="">
                                    <div class="flex-grow-1">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="">
                                                    <img src="{{asset('assets/images/top-products/01.png')}}" class="rounded-circle"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="">
                                                    <img src="{{asset('assets/images/top-products/02.png')}}" class="rounded-circle"
                                                        width="50" height="50" alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="">
                                                    <img src="{{asset('assets/images/top-products/03.png')}}" class="rounded-circle"
                                                        width="50" height="50" alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="">
                                                    <img src="{{asset('assets/images/top-products/04.png')}}" class="rounded-circle"
                                                        width="50" height="50" alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="">
                                                    <img src="{{asset('assets/images/top-products/06.png')}}" class="rounded-circle"
                                                        width="50" height="50" alt="">
                                                </div>
