            ...
            <div class="row g-3">
                ...
                <div class="col-auto">
                    <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                        ...
                        <a href="{{ route('qc.sqf_3.add') }}" class="btn  px-4"
                            ...
                            <tbody>
                                ...
                                @foreach ($sqf03Record as $item)
                                    <tr class="text-center">
                                        ...
                                        <td width="100px">
                                            <a class="" href="{{ route('qc.sqf_3.show', $item->id) }}">
                                                <i class="bi bi-eye-fill me-2"></i>
                                            </a>
                                            <a class="" href="{{ route('qc.sqf_3.edit', $item->id) }}">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer border-top-0">
                                                    <form action="{{ route('qc.sqf_3.destroy', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
