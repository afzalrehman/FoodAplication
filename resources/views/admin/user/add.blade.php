                ...
                <form class="row g-3 " action="{{url('admin/user/add')}}" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="position" name="role" class="form-select" required="">
                            ...
                            <option {{(old('role') == 'Plant_Manager' ? 'selected': '')}} value="Plant_Manager">Plant Manager</option>
                            <option {{(old('role') == 'QC' ? 'selected': '')}} value="QC">QC</option>
                            <option {{(old('role') == 'Supervisor' ? 'selected': '')}} value="Supervisor">Supervisor</option>
                        </select>
