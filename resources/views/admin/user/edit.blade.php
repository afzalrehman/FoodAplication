            ...
            <div class="card-body p-4">
                <form class="row g-3 " action="{{url('admin/user/update/'.$editUser->id)}}" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="phone" value="{{$editUser->phone}}"  id="phone" placeholder="Phone"
                            required="">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="position" name="role" class="form-select" required="">
                            ...
                            <option {{ ($editUser->role == 'Plant_Manager' ? 'selected': '')}} value="Plant_Manager">Plant Manager</option>
                            <option {{ ($editUser->role == 'QC' ? 'selected': '')}} value="QC">QC</option>
