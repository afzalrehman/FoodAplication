...
namespace App\Http\Controllers\qc\haccp;
...
class HACCP03Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('QC.haccp.haccp_03.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('QC.haccp.haccp_03.add', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($data->save()) {
            return redirect()->route('qc.haccp_3.index')->with('success', 'Data saved successfully');
        } else {
    ...
    public function show(string $id)
    {
        ...
        return view('QC.haccp.haccp_03.view', $data);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('QC.haccp.haccp_03.edit', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if (!$data) {
            return redirect()->route('qc.haccp_3.index')->withErrors('Item not found.');
        }

        if ($data->save()) {
            return redirect()->route('qc.haccp_3.index')->with('success', 'Data updated successfully');
        } else {
            return redirect()->back()->withErrors('Failed to save the data. Please try again.');
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        if ($data->delete()) {
            return redirect()->route('qc.haccp_3.index')->with('success', 'Data deleted successfully.');
        } else {
