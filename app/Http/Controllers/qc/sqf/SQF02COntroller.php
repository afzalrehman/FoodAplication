...
class SQF02COntroller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('QC.sqf.sqf_02.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('QC.sqf.sqf_02.add', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$data) {
            return redirect()->route('qc.sqf_2.index')->withErrors('Item not found.');
        }

        if ($data->save()) {
            return redirect()->route('qc.sqf_2.index')->with('success', 'Data saved successfully');
        } else {
    ...
    public function show(string $id)
    {
        ...
        return view('QC.sqf.sqf_02.view', $data);
    }
    ...
    public function edit(string $id)
    {
        ...
        // Return the view with data
        return view('QC.sqf.sqf_02.edit', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($data->save()) {
            return redirect()->route('qc.sqf_2.index')->with('success', 'Data Update successfully');
        } else {
            return redirect()->back()->withErrors('Failed to delete the item. Please try again.');
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        if ($data->delete()) {
            return redirect()->route('qc.sqf_2.index')->with('success', 'Data deleted successfully');
        } else {
            return redirect()->back()->withErrors('Failed to delete the item. Please try again.');
        }
    }
