...
class SQF03Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('QC.sqf.sqf_03.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('QC.sqf.sqf_03.add', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$data) {
            return redirect()->route('qc.sqf_3.index')->withErrors('Item not found.');
        }

        if ($data->save()) {
            return redirect()->route('qc.sqf_3.index')->with('success', 'Data saved successfully');
        } else {
    ...
    public function show(string $id)
    {
        ...
        if (!$data['sqf03Record']) {
            return redirect()->route('qc.sqf_3.index')->withErrors('Record not found.');
        }
        ...
        return view('QC.sqf.sqf_03.view', $data);
    }
    ...
    public function edit(string $id)
    {
        ...
        // Return the view with data
        return view('QC.sqf.sqf_03.edit', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($data->save()) {
            return redirect()->route('qc.sqf_3.index')->with('success', 'Data Update successfully');
        } else {
            return redirect()->back()->withErrors('Failed to delete the item. Please try again.');
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        if ($data->delete()) {
            return redirect()->route('qc.sqf_3.index')->with('success', 'Data deleted successfully');
        } else {
            return redirect()->back()->withErrors('Failed to delete the item. Please try again.');
        }
    }
