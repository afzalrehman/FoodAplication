...
class HACCP04Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('plant_manager.haccp.haccp_04.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('plant_manager.haccp.haccp_04.add', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($data->save()) {
            return redirect()->route('plantmanager.haccp_4.index')->with('success', 'Data saved successfully');
        } else {
    ...
    public function show(string $id)
    {
        ...
        return view('plant_manager.haccp.haccp_04.view', $data);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('plant_manager.haccp.haccp_04.edit', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if (!$data) {
            return redirect()->route('plantmanager.haccp_4.index')->withErrors('Item not found.');
        }

        if ($data->save()) {
            return redirect()->route('plantmanager.haccp_4.index')->with('success', 'Data updated successfully');
        } else {
            return redirect()->back()->withErrors('Failed to save the data. Please try again.');
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        if ($data->delete()) {
            return redirect()->route('plantmanager.haccp_4.index')->with('success', 'Data deleted successfully.');
        } else {
